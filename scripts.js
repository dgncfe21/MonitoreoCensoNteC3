...
var cars_Ref = firebase.database().ref('/LAMPARAS_E5vNteAb');


var dataConductores = firebase.database().ref('/LAMPARAS_E5vNteAb');
...
var pedidos_Ref = firebase.database().ref('/RPUMEDIDOR_E5vNteAb');
